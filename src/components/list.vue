...
<template>
  <div id="list">
    <header class="header mui-bar mui-bar-nav">
      ...
      <button @click="goAsi"  class="mui-btn mui-btn-link mui-btn-nav mui-pull-right"><span class="mui-icon  mui-icon-checkmarkempty"></span></button>
      <!--<router-link to="/asi">godo-asi</router-link>-->
